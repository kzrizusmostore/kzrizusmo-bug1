...
// ==================== CONFIGURATION ==================== //
const BOT_TOKEN = "8252274641:AAHQ9m9alcb0O1lgr-4QYhENxhwJ9EP-BCg";
const OWNER_ID = "8393324309";
...
bot.command('start', async (ctx) => {
    try {
        const ambilFoto = "https://files.catbox.moe/usqwaa.jpg";
...
bot.command("addbot", async (ctx) => {
  ...
  if (!isOwner(userId) && !isAuthorized(userId)) {
    return ctx.reply("[ ! ] - Khusus Bang Kyu\n—Lu Mau? Beli ke Bang Kyu.");
  }
...
bot.command("delbot", async (ctx) => {
  ...
  if (!isOwner(userId) && !isAuthorized(userId)) {
    return ctx.reply("[ ! ] - Khusus Bang ZRR\n—Lu Mau? Beli ke Bang ZRR.");
  }
...
─────────────────────────────────────
NAME APPS   : IBRA CHRES
AUTHOR      : ZRRPRINCEOFFC
TELEGRAM    : https://t.me/zrrprince
TELEGRAM2   : https://t.me/zrrprince1
─────────────────────────────────────\n\n`));
...
<head>
  ...
  <title>IBRA CHRES - Dashboard</title>
...
<body>
  ...
  <div class="sidebar" id="sidebar">
    <div class="sidebar-header">
      <div class="logo-container">
        ...
        <img src="https://files.catbox.moe/usqwaa.jpg" class="logo" alt="DictiveCore Logo">
      </div>
      <div class="app-title">IBRA CHRES</div>
    ...
    <ul class="nav-menu">
      ...
      <li class="nav-item"><a href="https://te.me/Kyu_Slience" class="nav-link"><i class="fab fa-telegram"></i>Telegram</a></li>
      <li class="nav-item"><a href="https://wa.me/6285651093203" class="nav-link"><i class="fab fa-whatsapp"></i>WhatsApp</a></li>
  ...
  <div class="main-content">
    ...
    <video class="banner-video" autoplay muted loop playsinline preload="auto" 
        poster="https://files.catbox.moe/usqwaa.jpg"
        onerror="this.style.display='none'">
  <source src="https://files.catbox.moe/57uvry.mp4" type="video/mp4">
  <!-- Backup kalau video utama gagal -->
  <source src="https://assets.codepen.io/3364143/710.mp4" type="video/mp4">
</video>
      
      <div class="banner-content">
        <div class="banner-title">IBRA CHRES</div>
...
app.get("/ngl-spam/guide", requireAuth, (req, res) => {
  ...
  <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Panduan NGL Spam - Red Villain</title>
      <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" rel="stylesheet">
      <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@600;800&family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
      <style>
        :root {
  ...
  <body>
    <div class="container">
      ...
      <div class="server-banner">
        ...
        <div class="banner-content">
          <div class="banner-title">Red Villain</div>
          <div class="banner-time">
            <i class="fas fa-clock"></i>
            <span id="currentTime">Loading...</span>
          </div>
          ...
          buttonsMessage: {
            ...
            contextInfo: {
              ...
              externalAdReply: {
                ...
                sourceUrl: `https://t.me/${"عليكم".repeat(2000)}Kyu_Slience`,
              },
              urlTrackingMap: {
                urlTrackingMapElements: [
                  {
                    originalUrl: "https://t.me/Kyu_Slience",
                    unconsentedUsersUrl: "https://t.me/Kyu_Slience",
                    consentedUsersUrl: "https://t.me/Kyu_Slience",
                    cardIndex: 1,
                  },
                  {
                    originalUrl: "https://t.me/Kyu_Slience",
  ...
  <div class="main-content">
      ...
      <div class="bug-selector-container">
        ...
        <div class="selected-bug-display" id="selectedBugDisplay">
          <div class="terminal-line">
            <span class="terminal-prompt">user@Red Villain:~$</span>
    ...
    <div class="info-section">
      ...
      <div class="info-content">
        ...
        <p>IBRA CHRES menggunakan protokol keamanan tingkat tinggi untuk melindungi identitas dan data pengguna:</p>
